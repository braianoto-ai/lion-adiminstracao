            ...
            return (
              <div key={v.id} className={`veh-card${isExpanded ? ' veh-expanded' : ''}`}>
                <div className="veh-card-main" onClick={() => setExpandedVehId(isExpanded ? null : v.id)}>
                  <div className="veh-icon"><svg viewBox="0 0 24 24" fill="none"><path d="M5 11l1.5-4.5A2 2 0 0 1 8.4 5h7.2a2 2 0 0 1 1.9 1.5L19 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><rect x="2" y="11" width="20" height="7" rx="2" stroke="currentColor" strokeWidth="1.5"/><circle cx="7" cy="18" r="2.2" fill="var(--amber)" stroke="var(--bg2)" strokeWidth="1"/><circle cx="17" cy="18" r="2.2" fill="var(--amber)" stroke="var(--bg2)" strokeWidth="1"/><path d="M2 14h20" stroke="currentColor" strokeWidth="1" opacity=".3"/><rect x="9" y="7.5" width="6" height="3" rx=".8" fill="currentColor" opacity=".15"/><path d="M5.5 11h13" stroke="currentColor" strokeWidth="1" opacity=".4" strokeLinecap="round"/></svg></div>
