...
const OB_STEPS = [
  {
    ...
    title: 'Bem-vindo ao Lion Admin', body: 'Seu painel completo de gestão financeira e patrimonial. Em menos de 2 minutos você estará configurado e pronto para usar.', cta: 'Começar tour',
  },
  {
    ...
    title: 'Registre suas Finanças', body: 'Clique no botão "Finanças" (ou pressione F) para lançar receitas e despesas. Acompanhe seu saldo mensal e histórico de transações.', cta: 'Entendido',
  },
  {
    ...
    title: 'Defina Metas Financeiras', body: 'Crie objetivos como reserva de emergência, viagem ou compra de imóvel. Acompanhe o progresso em tempo real com barras visuais.', cta: 'Entendido',
  },
  {
    ...
    title: 'Gerencie Imóveis e Aluguéis', body: 'Cadastre seus imóveis, controle recebimento de aluguéis, registre manutenções e armazene documentos importantes com segurança.', cta: 'Entendido',
  },
  {
    ...
    title: 'Tudo pronto!', body: 'Use os botões flutuantes à direita ou os atalhos de teclado (pressione ? para ver todos). Seus dados ficam salvos localmente no seu dispositivo.', cta: 'Ir para o painel',
  },
]
